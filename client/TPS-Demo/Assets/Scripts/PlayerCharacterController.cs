...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        // GUI.Label(new Rect(25, 25, 200, 20),  "HP : " + m_Health.currentHealth);
        // GUI.Label(new Rect(25, 50, 200, 20),  "Weapon Ammo : " + m_WeaponsManager.GetActiveWeapon().m_CurrentAmmo);
    }
    ...
    void HandleCharacterMovement()
    {
        ...
        // vertical camera rotation
        {
            ...
            m_CameraVerticalAngle = Mathf.Clamp(m_CameraVerticalAngle, -60f, 60f);
        ...
        bool isSprinting = m_InputHandler.GetSprintInputHeld();
        {
            ...
            if (isGrounded)
            {
                m_Animator.SetFloat("verticalVelocity", 0f);
                ...
                // Debug.Log("moving" + speedModifier);
                m_Animator.SetFloat("walkSpeed", targetVelocity.magnitude);
    ...
    void UpdateCharacterHeight(bool force)
    {
        ...
        if (force)
        {
            ...
            playerCamera.transform.localPosition = Vector3.up * m_TargetCharacterHeight * cameraHeightRatio + new Vector3(0f, 1.5f, -2.5f);
            m_Actor.aimPoint.transform.localPosition = m_Controller.center;
        }
        // Update smooth height
        else if (m_Controller.height != m_TargetCharacterHeight)
        {
            Debug.Log(m_Controller.height +";"+ m_TargetCharacterHeight);
            // resize the capsule and adjust camera position
            m_Controller.height = Mathf.Lerp(m_Controller.height, m_TargetCharacterHeight, crouchingSharpness * Time.deltaTime);
            m_Controller.center = Vector3.up * m_Controller.height * 0.5f;
            playerCamera.transform.localPosition = Vector3.Lerp(playerCamera.transform.localPosition, Vector3.up * m_TargetCharacterHeight * cameraHeightRatio + new Vector3(0f, 1.5f, -2.5f), crouchingSharpness * Time.deltaTime);
            m_Actor.aimPoint.transform.localPosition = m_Controller.center;
        }
    }
