...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (activeWeapon && m_WeaponSwitchState == WeaponSwitchState.Up)
        {
            ...
            bool reloadAmmo = activeWeapon.ReloadAmmo(m_InputHandler.GetReloadAmmoInputDown());
            bool switchFireMode = activeWeapon.SwitchFireMode(m_InputHandler.GetSwitchFireModeInputDown());
            ...
            m_Animator.SetBool("hasFired", hasFired);
            m_Animator.SetBool("isReloading", reloadAmmo);
    ...
    public bool AddWeapon(WeaponController weaponPrefab)
    {
        ...
        for (int i = 0; i < m_WeaponSlots.Length; i++)
        {
            ...
            if(m_WeaponSlots[i] == null)
            {
                ...
                weaponInstance.weaponAnimator = m_Animator;
    ...
    {
        Debug.LogWarning("weapon index:" + activeWeaponIndex);
        Debug.LogWarning("weapon slots:" + m_WeaponSlots.Length);
